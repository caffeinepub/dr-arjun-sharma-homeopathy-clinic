...
import type { DoctorProfile as _DoctorProfile } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async addService(arg0: string, arg1: string, arg2: SessionToken): Promise<bigint> {
    ...
    async deleteService(arg0: bigint, arg1: SessionToken): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllContactMessages(arg0: SessionToken): Promise<Array<ContactMessage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllContactMessages(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setDoctorProfile(arg0: DoctorProfile, arg1: SessionToken): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setDoctorProfile(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateService(arg0: bigint, arg1: string, arg2: string, arg3: SessionToken): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DoctorProfile]): DoctorProfile | null {
